  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 15, fontWeight: 600, color: '#1F1B1A' }}>Clientes ativos</h3>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <p style={{ fontSize: 13, fontWeight: 600, color: '#1F1B1A' }} className="truncate group-hover:text-[#F25BA5] transition-colors">
                    {client.name}
                  </p>
                </div>
                <p style={{ fontSize: 11, color: 'rgba(31,27,26,0.45)', marginTop: 1 }} className="truncate">
                  {client.segment}
                </p>
              </div>
              ...
              {ig && ig.connected && (
                <div className="text-right flex-shrink-0">
                  <p style={{ fontSize: 13, fontWeight: 600, color: '#1F1B1A' }}>{formatNumber(ig.followers)}</p>
              ...
              {ig && !ig.connected && (
                <span style={{ fontSize: 11, color: 'rgba(31,27,26,0.4)' }}>N/C</span>
              )}
            </Link>
          )
        })}
